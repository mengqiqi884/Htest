...
class WeChatOAuth{
    ...
    public static function getCode($redirect_uri, $state=1, $scope='snsapi_base'){
        ...
        //$redirect_uri = Config::WECHAT_URL . $redirect_uri;
    ...
    public static function getAccessTokenAndOpenId($code){
        ...
        //构造请求微信接口的URL
        $url = 'https://api.weixin.qq.com/sns/oauth2/access_token?appid='.Config::WECHAT_APPID.'&secret='.Config::WECHAT_APPSECRET.'&code='.$code.'&grant_type='.$grant_type.'';
    ...
    public static function refreshToken($refreshToken){
        $queryUrl = 'https://api.weixin.qq.com/sns/oauth2/refresh_token?appid='.Config::WECHAT_APPID.'&grant_type=refresh_token&refresh_token='.$refreshToken;
        $queryAction = 'GET';
