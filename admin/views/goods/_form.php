        ...
        <div class="col-sm-6">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <?=$form->field($model, 'g_amount')->widget(\kartik\touchspin\TouchSpin::className(),[
                        'pluginOptions' => [
                            'buttonup_class' => 'btn btn-primary', //"+"的class
                            'buttondown_class' => 'btn btn-info',  //"-"的class
                            'buttonup_txt' => '<i class="fa fa-plus-circle"></i>',  //图标“+”
                            'buttondown_txt' => '<i class="fa fa-minus-circle"></i>', //图标“-”
                            'initval' => 1, //默认初值
                            'min' => 1, //最小值
                            'max' => 100,  //最大值
