...
/**
 * This is the model class for table "admin_item".
...
class AuthItem extends BaseModel
{
    ...
    public static function getItemNameById($id) {
        $model = AuthItem:: findOne(['i_id'=>$id]);
        if(!$model)
            throw new \Exception( '编辑的角色或权限不存在！'.$id );
